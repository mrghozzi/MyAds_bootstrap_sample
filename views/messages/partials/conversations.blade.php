...
@empty
    <div class="messages-rail-empty text-center p-4" data-conversation-empty>
        <i class="fa fa-comments fa-2x mb-2 text-muted" aria-hidden="true"></i>
        <p class="text-muted small">{{ __('messages.no_msg') }}</p>
    </div>
@endforelse
