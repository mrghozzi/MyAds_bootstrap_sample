...
<style>
    ...
    [data-theme="dark"] .custom-ads-card { border-color: #2f3749; background: #1d2333; }
    .custom-ads-card h4 { margin: 0 0 8px; color: #3e3f5e; font-size: 1rem; font-weight: 800; }
    [data-theme="dark"] .custom-ads-card h4 { color: #fff; }
    .custom-ads-muted { color: #8f91ac; font-size: .86rem; line-height: 1.6; }
    [data-theme="dark"] .custom-ads-muted { color: #9aa4bf; }
    .custom-ads-stat { font-size: 1.55rem; color: #0f766e; font-weight: 900; }
    [data-theme="dark"] .custom-ads-stat { color: #14b8a6; }
    ...
    [data-theme="dark"] .custom-ads-pill { background: #115e59; color: #ccfbf1; }
    ...
    [data-theme="dark"] .custom-ads-table th { border-bottom-color: #2f3749; color: #9aa4bf; }
    .custom-ads-table td { padding: 14px; border-bottom: 1px solid #f3f4f8; vertical-align: top; }
    [data-theme="dark"] .custom-ads-table td { border-bottom-color: #2f3749; }
    ...
    [data-theme="dark"] .custom-ads-preview { border-color: #2f3749; background: #1a202c; }
    ...
    [data-theme="dark"] .custom-ads-code { border-color: #2f3749; color: #e2e8f0; background: #1a202c; }
    ...
    [data-theme="dark"] .widget-box select,
    [data-theme="dark"] .widget-box input[type="url"],
    [data-theme="dark"] .custom-ads-shell select,
    [data-theme="dark"] .custom-ads-shell input[type="url"] {
        border-color: #2f3749;
    ...
    [data-theme="dark"] .widget-box select:focus,
    [data-theme="dark"] .widget-box input[type="url"]:focus,
    [data-theme="dark"] .custom-ads-shell select:focus,
    [data-theme="dark"] .custom-ads-shell input[type="url"]:focus {
