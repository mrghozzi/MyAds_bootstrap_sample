<style>
    ...
    .store-content-card .card-body,
    .kb-main-card .card-body,
    .kb-side-card .card-body,
    .kb-form-card .card-body,
    .kb-helper-card .card-body {
        padding-top: 0;
    }
    ...
    .kb-main-card .card-header,
    .kb-side-card .card-header,
    .kb-form-card .card-header,
    .kb-helper-card .card-header {
        color: var(--store-shell-title);
    }
