<div class="card border-0 shadow-sm rounded-4 mb-4 profile-relationships-summary">
    <div class="profile-relationships-summary__top">
        ...
        <div class="profile-relationships-summary__identity">
            <p class="fw-bold fs-5 mb-0">
                <a class="profile-relationships-summary__user-link text-decoration-none" href="{{ route('profile.show', $user->username) }}">{{ $user->username }}</a>
            </p>
