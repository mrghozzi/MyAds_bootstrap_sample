    ...
    @if($mediaUrl)
        <div class="saved-reel-card">
            <a href="{{ route('clips.index') }}#{{ $activity->id }}" class="saved-reel-link">
                ...
                <div class="saved-reel-overlay">
                    <div class="icon-play-btn">
                        <svg class="icon-play" viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="M8 5v14l11-7z"/></svg>
                    </div>
            ...
            <div class="saved-reel-info">
                <p class="saved-reel-caption" dir="auto">{{ strip_tags(\App\Support\ContentFormatter::format($activity->txt)) }}</p>
