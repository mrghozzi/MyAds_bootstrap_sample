        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                <h6 class="fw-bold mb-0">
                    ...
                    @endif
                    <small class="text-muted fw-normal ms-1">{{ (int)$activity->s_type === 14 ? __('messages.added_clips') : __('messages.added_video') }}</small>
                </h6>
...
@if(auth()->id() == $activity->uid || auth()->user()->isAdmin())
    ...
    <div class="card-body p-4">
        ...
        <div class="post-content post_text{{ $activity->related_content->id }}">
            ...
            @if($video)
                <div class="ratio ratio-16x9 rounded-3 overflow-hidden border bg-black mb-3">
