...
<div class="quick-post composer-refresh" id="social-composer">
    <form class="form" action="{{ route('status.create') }}" method="POST" enctype="multipart/form-data" id="social-composer-form">
        ...
        <div class="quick-post-body composer-refresh__body">
            ...
            @if($allowRepost)
                <div id="composer-repost-card" class="composer-refresh__panel composer-refresh__panel--repost" style="display:none;">
                    <div class="composer-refresh__panel-content">
            ...
            @if($allowLink)
                <div id="composer-link-block" class="composer-refresh__panel composer-refresh__panel--link" style="display:none;">
                    <div class="composer-refresh__panel-content">
            ...
            @if($allowGallery)
                <div id="composer-gallery-block" class="composer-refresh__panel composer-refresh__panel--gallery" style="display:none;">
                    <div class="composer-refresh__panel-content">
            ...
            @if($allowVideo)
            <div id="composer-video-block" class="composer-refresh__panel" style="display:none;">
                <div class="composer-refresh__panel-content p-3">
                    ...
                    <div class="composer-refresh__field mb-3">
                        ...
                        <input
                            ...
                            onchange="if(this.files && this.files[0]){ var r = new FileReader(); r.onload = function(e){ var img = document.getElementById('composer-video-thumb-preview-bs'); img.src = e.target.result; document.getElementById('composer-video-thumb-wrap-bs').style.display='block'; }; r.readAsDataURL(this.files[0]); }"
                        >
                        <div id="composer-video-thumb-wrap-bs" class="mt-2" style="display:none;">
                            <p class="small text-muted mb-1">معاينة غلاف الفيديو:</p>
                            <img id="composer-video-thumb-preview-bs" src="" style="max-height: 120px; border-radius: 8px; border: 1px solid var(--border-color, #e0e6ed); object-fit: cover;">
                        </div>
                    </div>
            ...
            @if($allowAudio)
            <div id="composer-audio-block" class="composer-refresh__panel" style="display:none;">
                <div class="composer-refresh__panel-content">
            ...
            @if($allowFiles)
            <div id="composer-file-block" class="composer-refresh__panel" style="display:none;">
                <div class="composer-refresh__panel-content">
...
@push('head')
    <style>
        ...
        html[data-bs-theme="dark"] #social-composer.composer-refresh,
        ...
        html[data-bs-theme="dark"] #social-composer.composer-refresh .composer-refresh__control:focus,
        ...
        html[data-bs-theme="dark"] #social-composer.composer-refresh .composer-refresh__ghost-button--danger:hover,
        ...
        html[data-bs-theme="dark"] #social-composer.composer-refresh .composer-refresh__footer,
