...
<article class="card border-0 shadow-sm rounded-4 mb-3 profile-relationship-card">
            ...
            <div class="profile-relationship-card__content">
                <div class="profile-relationship-card__title">
                    <p class="profile-relationship-card__name">
                        <a href="{{ $profileRoute }}" class="user-popover-trigger" data-username="{{ $targetUser->username }}">{{ $targetUser->username }}</a>
                    </p>
                </div>
