    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4 p-md-5">
                <h4 class="fw-bold text-dark mb-4">{{ __('messages.add_banner') }}</h4>
                <form action="{{ route('ads.banners.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="img" class="form-control form-control-lg bg-light border-0" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label small fw-bold">{{ __('messages.img') }} (Version B - Optional)</label>
                        <input type="text" name="img_b" class="form-control form-control-lg bg-light border-0">
