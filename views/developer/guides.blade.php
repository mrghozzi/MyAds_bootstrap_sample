        ...
        <div class="d-flex flex-column gap-4">
            <section id="step-1" class="card border-0 shadow-sm rounded-4 dev-panel dev-guide-section">
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info border-0 bg-primary bg-opacity-10 text-primary rounded-4 mt-4 mb-4">
...
scope=dev_scope_identity_read</code></pre>
            ...
            <section id="step-3" class="card border-0 shadow-sm rounded-4 dev-panel dev-guide-section">
                <div class="card-body p-4">
