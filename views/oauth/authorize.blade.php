...
@php
    ...
    $scopeIcons = [
        ...
        'user.email.read' => 'fa-envelope',
        'user.social_links.read' => 'fa-share-nodes',
        'user.follows.read' => 'fa-user-group',
        'user.follows.write' => 'fa-user-plus',
        'user.content.read' => 'fa-newspaper',
        'user.content.write' => 'fa-pen-to-square',
        'user.reactions.write' => 'fa-heart',
        'user.comments.write' => 'fa-comments',
        'user.messages.read' => 'fa-envelope-open-text',
        'user.messages.write' => 'fa-paper-plane',
        'user.notifications.read' => 'fa-bell',
        'user.wallet.read' => 'fa-wallet',
        'user.badges.read' => 'fa-award',
        'user.clips.read' => 'fa-film',
        'user.clips.write' => 'fa-bookmark',
        'user.forums.read' => 'fa-comments',
        'user.forums.write' => 'fa-message',
        'user.store.read' => 'fa-store',
        'user.orders.read' => 'fa-cart-shopping',
        'user.ads.read' => 'fa-chart-line',
...
<div class="oauth-consent-shell">
    <div class="card border-0 shadow-sm rounded-4 oauth-consent-card p-0">
        ...
        <div class="card-body oauth-consent-content">
            ...
            <form action="{{ route('oauth.authorize.post') }}" method="POST" class="oauth-consent-form">
                ...
                <div class="oauth-consent-actions">
                    <button type="submit" name="action" value="accept" class="btn btn-primary rounded-pill fw-bold d-flex align-items-center justify-content-center gap-2 px-4 py-2">
                        <i class="fa-solid fa-check"></i>
                        <span>{{ __('messages.authorize') }}</span>
                    </button>
                    <button type="submit" name="action" value="reject" class="btn btn-light border rounded-pill fw-bold d-flex align-items-center justify-content-center gap-2 px-4 py-2">
